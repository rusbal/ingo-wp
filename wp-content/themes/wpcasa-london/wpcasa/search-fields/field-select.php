...
<div class="listings-search-field listings-search-field-<?php echo esc_attr( $fields[ $field ]['type'] ); ?> listings-search-field-<?php echo esc_attr( $field ); ?> <?php echo esc_attr( $class ); ?>">
	...
	<select id="listing-search-<?php echo sanitize_html_class( $field ); ?>-<?php echo esc_attr( uniqid() ); ?>" class="listing-search-<?php echo sanitize_html_class( $field ); ?> select selectpicker form-control" name="<?php echo wpsight_get_query_var_by_detail( $field ); ?>">
