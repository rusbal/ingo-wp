...
add_action( 'widgets_init', 'wpsight_london_register_widget_listings_query' );
 
function wpsight_london_register_widget_listings_query() {
	register_widget( 'WPSight_London_Listings_Query' );
}
...
class WPSight_London_Listings_Query extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'wpsight_london_Listings_Query', '&rsaquo; ' . _x( 'Listings Query', 'listing widget', 'wpcasa-london' ), $widget_ops );
	...
	public function widget( $args, $instance ) {
		...
		$listings_args = apply_filters( 'wpsight_london_widget_listings_query_query_args', array_merge( $listings_args, $taxonomy_filters ), $instance, $this->id );
