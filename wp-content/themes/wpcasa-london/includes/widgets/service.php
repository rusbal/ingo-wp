 ...
 * Register widget
 */
add_action( 'widgets_init', 'wpsight_london_register_widget_service' );
 
function wpsight_london_register_widget_service() {
	register_widget( 'WPSight_London_Service' );
}

/**
 * Service widget class
 */
class WPSight_London_Service extends WP_Widget {

	public function __construct() {

		$widget_ops = array(
			'classname'   => 'widget_service',
			'description' => _x( 'Display a service.', 'listing wigdet', 'wpcasa-london' )
		);

		parent::__construct( 'wpsight_london_service', '&rsaquo; ' . _x( 'Service', 'listing widget', 'wpcasa-london' ), $widget_ops );
	...
	public function widget( $args, $instance ) {
		...
		// Display feature box
		wpsight_london_service( $instance, $args );
	...
	public function form( $instance ) {
		...
		<p><label for="<?php echo $this->get_field_id( 'icon_class' ); ?>"><?php _e( 'Icon', 'wpcasa-london' ); ?>: <input class="widefat" id="<?php echo $this->get_field_id( 'icon_class' ); ?>" name="<?php echo $this->get_field_name( 'icon_class' ); ?>" type="text" value="<?php echo esc_attr( $instance['icon_class'] ); ?>" /></label><br />
