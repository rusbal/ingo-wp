 ...
 * Register widget
 */
add_action( 'widgets_init', 'wpsight_london_register_widget_listing_image_gallery' );
 
function wpsight_london_register_widget_listing_image_gallery() {
	register_widget( 'WPSight_London_Listing_Image_Gallery' );
}

/**
 * Listing gallery widget class
 */
class WPSight_London_Listing_Image_Gallery extends WP_Widget {

	public function __construct() {

		$widget_ops = array(
			'classname'   => 'widget_listing_image_gallery',
			'description' => _x( 'Display listing images in thumbnail gallery.', 'listing wigdet', 'wpcasa-london' )
		);

		parent::__construct( 'wpsight_london_listing_image_gallery', '&rsaquo; ' . _x( 'Single Listing Image Gallery', 'listing widget', 'wpcasa-london' ), $widget_ops );
	...
	public function form( $instance ) {
		...
		<p><label for="<?php echo $this->get_field_id( 'thumbs_columns' ); ?>"><?php _e( 'Columns', 'wpcasa-london' ); ?>:</label><br />
			<select class="widefat" id="<?php echo $this->get_field_id( 'thumbs_columns' ); ?>" name="<?php echo $this->get_field_name( 'thumbs_columns' ); ?>">
				<option value="12"<?php selected( $thumbs_columns, 12 ); ?>>1 <?php _ex( 'column', 'listing widget', 'wpcasa-london' ); ?></option>
				<option value="6"<?php selected( $thumbs_columns, 6 ); ?>>2 <?php _ex( 'columns', 'listing widget', 'wpcasa-london' ); ?></option>
				<option value="4"<?php selected( $thumbs_columns, 4 ); ?>>3 <?php _ex( 'columns', 'listing widget', 'wpcasa-london' ); ?></option>
				<option value="3"<?php selected( $thumbs_columns, 3 ); ?>>4 <?php _ex( 'columns', 'listing widget', 'wpcasa-london' ); ?></option>
				<option value="2"<?php selected( $thumbs_columns, 2 ); ?>>6 <?php _ex( 'columns', 'listing widget', 'wpcasa-london' ); ?></option>
				<option value="1"<?php selected( $thumbs_columns, 1 ); ?>>12 <?php _ex( 'columns', 'listing widget', 'wpcasa-london' ); ?></option>
			</select><br />
			<span class="description"><?php _e( 'Please select the number of columns', 'wpcasa-london' ); ?></span></p>
		
		<p><label for="<?php echo $this->get_field_id( 'thumbs_columns_small' ); ?>"><?php _e( 'Columns', 'wpcasa-london' ); ?> (<?php _ex( 'on small screens', 'listing widget', 'wpcasa-london' ); ?>):</label><br />
			<select class="widefat" id="<?php echo $this->get_field_id( 'thumbs_columns_small' ); ?>" name="<?php echo $this->get_field_name( 'thumbs_columns_small' ); ?>">
				<option value="12"<?php selected( $thumbs_columns_small, 12 ); ?>>1 <?php _ex( 'column', 'listing widget', 'wpcasa-london' ); ?></option>
				<option value="6"<?php selected( $thumbs_columns_small, 6 ); ?>>2 <?php _ex( 'columns', 'listing widget', 'wpcasa-london' ); ?></option>
				<option value="4"<?php selected( $thumbs_columns_small, 4 ); ?>>3 <?php _ex( 'columns', 'listing widget', 'wpcasa-london' ); ?></option>
				<option value="3"<?php selected( $thumbs_columns_small, 3 ); ?>>4 <?php _ex( 'columns', 'listing widget', 'wpcasa-london' ); ?></option>
				<option value="2"<?php selected( $thumbs_columns_small, 2 ); ?>>6 <?php _ex( 'columns', 'listing widget', 'wpcasa-london' ); ?></option>
				<option value="1"<?php selected( $thumbs_columns_small, 1 ); ?>>12 <?php _ex( 'columns', 'listing widget', 'wpcasa-london' ); ?></option>
			</select><br />
			<span class="description"><?php _e( 'Please select the number of columns', 'wpcasa-london' ); ?> (<?php _ex( 'on small screens', 'listing widget', 'wpcasa-london' ); ?>)</span></p>
		
		<p><label for="<?php echo $this->get_field_id( 'thumbs_gutter' ); ?>"><?php _e( 'Gutter', 'wpcasa-london' ); ?>:</label><br />
			...
			<span class="description"><?php _e( 'Please select the gutter width (space between thumbs)', 'wpcasa-london' ); ?></span></p>
		
		<p><label for="<?php echo $this->get_field_id( 'thumbs_size' ); ?>"><?php _e( 'Thumbnail Size', 'wpcasa-london' ); ?>:</label><br />
			...
			<span class="description"><?php _e( 'Please select the thumbnail size', 'wpcasa-london' ); ?></span></p>
		...
		<p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'thumbs_caption' ); ?>" name="<?php echo $this->get_field_name( 'thumbs_caption' ); ?>"<?php checked( $thumbs_caption ); ?> />
			<label for="<?php echo $this->get_field_id( 'thumbs_caption' ); ?>"><?php _e( 'Display thumbnail captions (if any)', 'wpcasa-london' ); ?></label></p>
		...
		<p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'thumbs_link' ); ?>" name="<?php echo $this->get_field_name( 'thumbs_link' ); ?>"<?php checked( $thumbs_link ); ?> />
			<label for="<?php echo $this->get_field_id( 'thumbs_link' ); ?>"><?php _e( 'Link thumbnails to image file (in lightbox)', 'wpcasa-london' ); ?></label></p>
		
		<div<?php if( ! $thumbs_link || apply_filters( 'wpsight_london_lightgallery', true ) != true ) echo ' style="display:none"'; ?>>
		
				<p><label for="<?php echo $this->get_field_id( 'lightbox_size' ); ?>"><?php _e( 'Lightbox Size', 'wpcasa-london' ); ?>:</label><br />
				...
				<span class="description"><?php _e( 'Please select the image size for the lightbox', 'wpcasa-london' ); ?></span></p>
				
				<p><label for="<?php echo $this->get_field_id( 'lightbox_mode' ); ?>"><?php _e( 'Animation', 'wpcasa-london' ); ?>:</label><br />
				<select class="widefat" id="<?php echo $this->get_field_id( 'lightbox_mode' ); ?>" name="<?php echo $this->get_field_name( 'lightbox_mode' ); ?>">
					<option value="fade"<?php selected( $lightbox_mode, 'fade' ); ?>><?php _ex( 'fade', 'listing widget', 'wpcasa-london' ); ?></option>
					<option value="slide"<?php selected( $lightbox_mode, 'slide' ); ?>><?php _ex( 'slide', 'listing widget', 'wpcasa-london' ); ?></option>
				</select></p>
				...
				<label for="<?php echo $this->get_field_id( 'lightbox_caption' ); ?>"><?php _e( 'Show image descriptions in lightbox', 'wpcasa-london' ); ?></label></p>
				...
				<label for="<?php echo $this->get_field_id( 'lightbox_loop' ); ?>"><?php _e( 'Loop lightbox images', 'wpcasa-london' ); ?></label></p>
				...
				<label for="<?php echo $this->get_field_id( 'lightbox_prev_next' ); ?>"><?php _e( 'Show prev/next navigation in lightbox', 'wpcasa-london' ); ?></label></p>
				...
				<label for="<?php echo $this->get_field_id( 'lightbox_download' ); ?>"><?php _e( 'Show image download button', 'wpcasa-london' ); ?></label></p>
				...
				<label for="<?php echo $this->get_field_id( 'lightbox_zoom' ); ?>"><?php _e( 'Allow zoom option in lightbox', 'wpcasa-london' ); ?></label></p>
				...
				<label for="<?php echo $this->get_field_id( 'lightbox_fullscreen' ); ?>"><?php _e( 'Allow fullscreen toggle in lightbox', 'wpcasa-london' ); ?></label></p>
				...
				<label for="<?php echo $this->get_field_id( 'lightbox_counter' ); ?>"><?php _e( 'Show image counter in lightbox', 'wpcasa-london' ); ?></label></p>
				...
				<label for="<?php echo $this->get_field_id( 'lightbox_autoplay' ); ?>"><?php _e( 'Show autoplay controls in lightbox', 'wpcasa-london' ); ?></label></p>
				...
				<label for="<?php echo $this->get_field_id( 'lightbox_thumbs_size' ); ?>"><?php _e( 'Show thumbnail previews in lightbox', 'wpcasa-london' ); ?></label></p>
