 ...
 * Register widget
 */
add_action( 'widgets_init', 'wpsight_london_register_widget_listing_image_slider' );
 
function wpsight_london_register_widget_listing_image_slider() {
	register_widget( 'WPSight_London_Listing_Image_Slider' );
}

/**
 * Listing slider widget class
 */
class WPSight_London_Listing_Image_Slider extends WP_Widget {

	public function __construct() {

		$widget_ops = array(
			'classname'   => 'widget_listing_image_slider',
			'description' => _x( 'Display listing images in slider.', 'listing wigdet', 'wpcasa-london' )
		);

		parent::__construct( 'wpsight_london_listing_image_slider', '&rsaquo; ' . _x( 'Single Listing Image Slider', 'listing widget', 'wpcasa-london' ), $widget_ops );
	...
	public function form( $instance ) {
		...
		<div<?php if( ! $slider_dots ) echo ' style="display:none"'; ?>>
			...
			<div<?php if( ! $slider_dots_thumbs ) echo ' style="display:none"'; ?>>
				...
				<p><label for="<?php echo $this->get_field_id( 'slider_dots_thumbs_items' ); ?>"><?php _e( 'Number of thumbnail items', 'wpcasa-london' ); ?>:</label><br />
				...
				<p><label for="<?php echo $this->get_field_id( 'slider_dots_thumbs_margin' ); ?>"><?php _e( 'Margin between thumbnail items', 'wpcasa-london' ); ?>:</label><br />
		...
		<p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'slider_keyboard' ); ?>" name="<?php echo $this->get_field_name( 'slider_keyboard' ); ?>"<?php checked( $slider_keyboard ); ?> />
				<label for="<?php echo $this->get_field_id( 'slider_keyboard' ); ?>"><?php _e( 'Allow slider navigating via keyboard', 'wpcasa-london' ); ?></label></p>
		...
		<p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'image_caption' ); ?>" name="<?php echo $this->get_field_name( 'image_caption' ); ?>"<?php checked( $image_caption ); ?> />
			<label for="<?php echo $this->get_field_id( 'image_caption' ); ?>"><?php _e( 'Display image captions (if any)', 'wpcasa-london' ); ?></label></p>	
