 ...
 * Register widget
 */
add_action( 'widgets_init', 'wpsight_london_register_widget_section_title' );
 
function wpsight_london_register_widget_section_title() {
	register_widget( 'WPSight_London_Section_Title' );
}

/**
 * Service widget class
 */
class WPSight_London_Section_Title extends WP_Widget {

	public function __construct() {

		$widget_ops = array(
			'classname'   => 'widget_section_title',
			'description' => _x( 'Display a section title.', 'listing wigdet', 'wpcasa-london' )
		);

		parent::__construct( 'wpsight_london_section_title', '&rsaquo; ' . _x( 'Section Title', 'listing widget', 'wpcasa-london' ), $widget_ops );
	...
	public function widget( $args, $instance ) {
		...
		// Display feature box
		wpsight_london_section_title( $instance, $args );
	...
	public function form( $instance ) {
		...
		<p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'separator' ); ?>" name="<?php echo $this->get_field_name( 'separator' ); ?>"<?php checked( $instance['separator'] ); ?> />
			<label for="<?php echo $this->get_field_id( 'separator' ); ?>"><?php _e( 'Display a separotor under the title', 'wpcasa-london' ); ?></label></p>
		...
		<p><label for="<?php echo $this->get_field_id( 'align' ); ?>"><?php _e( 'Align', 'wpcasa-london' ); ?>:</label><br />
			<select class="widefat" id="<?php echo $this->get_field_id( 'align' ); ?>" name="<?php echo $this->get_field_name( 'align' ); ?>">
				<option value="left"<?php selected( $instance['align'], 'left' ); ?>><?php _ex( 'left', 'listing widget', 'wpcasa-london' ); ?></option>
				<option value="center"<?php selected( $instance['align'], 'center' ); ?>><?php _ex( 'center', 'listing widget', 'wpcasa-london' ); ?></option>
				<option value="right"<?php selected( $instance['align'], 'right' ); ?>><?php _ex( 'right', 'listing widget', 'wpcasa-london' ); ?></option>
			</select><br />
			<span class="description"><?php _e( 'Please select the alignment', 'wpcasa-london' ); ?></span></p>
