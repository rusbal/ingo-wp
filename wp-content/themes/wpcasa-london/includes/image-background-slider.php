...
/**
 * wpsight_london_image_background_slider()
 *
 ...
 *
 * @uses wpsight_london_get_image_background_slider()
 *
 * @since 1.0.0
 */
function wpsight_london_image_background_slider( $post_id = '', $args = array() ) {
	echo wpsight_london_get_image_background_slider( $post_id, $args );
}

/**
 * wpsight_london_get_image_background_slider()
 *
 * Create image slider.
 *
 * @param integer|array $post_id Post ID or array of attachment IDs
 ...
 * @since 1.0.0
 */
function wpsight_london_get_image_background_slider( $post_id = '', $args = array() ) {
	...
	if( $images ) {
		...
		$args = apply_filters( 'wpsight_london_get_image_background_slider_args', wp_parse_args( $args, $defaults ), $post_id, $args );
		...
		return apply_filters( 'wpsight_london_get_image_background_slider', ob_get_clean(), $post_id, $args, $slider_id );
