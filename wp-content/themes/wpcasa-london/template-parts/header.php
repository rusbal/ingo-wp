...
<div class="site-header-wrap<?php echo $header_filter ? ' site-header-wrap-no-filter' : ''; ?>">
	...
	<?php if( 'listings_slider' != $header_display ) : ?>
		...
		<header class="site-header site-header-gallery<?php echo $header_filter ? ' site-header-no-filter' : ''; ?>" role="banner">
			<div class="site-header-inner">
				<?php wpsight_london_image_background_slider(); ?>			
			</div><!-- .site-header-inner -->
		</header><!-- .site-header -->
	...
	<?php else : ?>
		...
		<?php
			...
			$listings_args = apply_filters( 'wpsight_london_header_listings_query_args', array_merge( $listings_args, $taxonomy_filters ), $instance, get_the_id() );
			...
			$slider_args = apply_filters( 'wpsight_london_header_listings_slider_args', $slider_args, $instance, get_the_id() );
		?>
	
		<header class="site-header site-header-listings<?php echo $header_filter ? ' site-header-no-filter' : ''; ?>" role="banner">
			<div class="site-header-inner">
				<?php wpsight_london_listings_slider( wpsight_get_listings( $listings_args ), $slider_args ); ?>	
			</div><!-- .site-header-inner -->
		</header><!-- .site-header -->
