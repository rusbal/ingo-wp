...
?>
			...
			<?php $bottom_left = sprintf( __( 'Copyright &copy; <span itemprop="copyrightYear">%s</span> &middot; <a href="%s" rel="home" itemprop="copyrightHolder">%s</a>', 'wpcasa-london' ), date( 'Y' ), esc_url( home_url( '/' ) ), get_bloginfo( 'name' ) ); ?>
			<?php $bottom_right = __( 'Built on <a href="http://wordpress.org">WordPress</a> &amp; <a href="https://wpcasa.com">WPCasa</a>', 'wpcasa-london' ); ?>
		...
		<?php do_action( 'wpsight_london_site_container_after' ); ?>
		
	</div><!-- .site-wrapper -->
	
	<?php do_action( 'wpsight_london_site_wrapper_after' ); ?>
