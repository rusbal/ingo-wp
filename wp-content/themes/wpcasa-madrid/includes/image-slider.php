 ...
 *
 * @uses wpsight_madrid_get_image_slider()
 *
 * @since 1.0.0
 */
function wpsight_madrid_image_slider( $post_id = '', $args = array() ) {
	echo wpsight_madrid_get_image_slider( $post_id, $args );
}

/**
 * wpsight_madrid_get_image_slider()
 *
 * Create image slider.
 *
 * @param integer|array $post_id Post ID or array of attachment IDs
 ...
 * @uses wpsight_madrid_image_slider_js()
 *
 * @return string HTML markup of image slider
 *
 * @since 1.0.0
 */
function wpsight_madrid_get_image_slider( $post_id = '', $args = array() ) {
	...
	if( $images ) {
		...
		$args = apply_filters( 'wpsight_madrid_get_image_slider_args', wp_parse_args( $args, $defaults ), $post_id, $args );
		...
		return apply_filters( 'wpsight_madrid_get_image_slider', ob_get_clean(), $post_id, $args, $slider_id );
