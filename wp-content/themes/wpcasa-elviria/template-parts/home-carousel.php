...
if( $carousel_display ) : ?>
	...
	<?php
		...
		$listings_args = apply_filters( 'wpsight_elviria_home_listings_carousel_query_args', array_merge( $listings_args, $taxonomy_filters ), $instance, 'home' );
	...
	<div id="home-carousel" class="site-section home-section">
		...
		<div class="container">
			...
			<div class="content 12u$">
				<?php wpsight_elviria_listings_carousel( $listings, $carousel_args ); ?>			
			</div>
