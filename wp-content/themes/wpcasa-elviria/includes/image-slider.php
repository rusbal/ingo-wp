<?php
/**
 * WPCasa Elviria listing image slider
 *
 * @package WPCasa Elviria
 */

/**
 * wpsight_elviria_image_slider()
 *
 * Echo wpsight_elviria_get_image_slider()
 *
 * @param integer|array $post_id Post ID or array of attachment IDs
 * @param array $args Optional gallery arguments
 *
 * @uses wpsight_elviria_get_image_slider()
 *
 * @since 1.0.0
 */
 
function wpsight_elviria_image_slider( $post_id = '', $args = array() ) {
	echo wpsight_elviria_get_image_slider( $post_id, $args );
}

/**
 * wpsight_elviria_get_image_slider()
 *
 ...
 * @uses wpsight_elviria_image_slider_root()
 * @uses wpsight_elviria_image_slider_js()
 *
...
function wpsight_elviria_get_image_slider( $post_id = '', $args = array() ) {
	...
	if( $images ) {
		...
		$args = apply_filters( 'wpsight_elviria_get_image_slider_args', wp_parse_args( $args, $defaults ), $post_id, $args );
		...
		if( apply_filters( 'wpsight_elviria_photoswipe', true ) == true ) {
			wpsight_elviria_image_slider_root( $args, $slider_id );
			wpsight_elviria_image_slider_js( $args, $slider_id );
		}
...
/**
 * wpsight_elviria_image_slider_root()
 *
 * Echo wpsight_elviria_get_image_slider_root()
 *
...
function wpsight_elviria_image_slider_root( $args = array(), $slider_id ) {
	echo wpsight_elviria_get_image_slider_root( $args, $slider_id );
}

/**
 * wpsight_elviria_get_image_slider_root()
 *
...
function wpsight_elviria_get_image_slider_root( $args = array(), $slider_id ) {
	...
	return apply_filters( 'wpsight_elviria_get_image_slider_root', ob_get_clean(), $args, $slider_id );

}

/**
 * wpsight_elviria_image_slider_js()
 *
 * Echo wpsight_elviria_get_image_slider_js()
 *
 * @param array $args Array of arguments
 * @param string $slider_id Unique ID for Photoswipe root element
 *
...
function wpsight_elviria_image_slider_js( $args = array(), $slider_id ) {
	echo wpsight_elviria_get_image_slider_js( $args, $slider_id );
}
...
function wpsight_elviria_get_image_slider_js( $args = array(), $slider_id ) {
	...
	return apply_filters( 'wpsight_elviria_get_image_slider_js', ob_get_clean(), $args, $slider_id );
