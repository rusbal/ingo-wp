<?php
/**
 * class WPSight_Elviria_Walker_Category_Checklist
 *
...
class WPSight_Elviria_Walker_Category_Checklist extends Walker_Category_Checklist {
...
/**
 * wpsight_elviria_listing_actions()
 *
 ...
 * @since 1.0.0
 */
add_filter( 'wpsight_listing_actions', 'wpsight_elviria_listing_actions' );

function wpsight_elviria_listing_actions( $output ) {
 ...
 * @since 1.0.0
 */
add_action( 'wp_enqueue_scripts', 'wpsight_elviria_dequeue_addon_scripts' );

function wpsight_elviria_dequeue_addon_scripts() {	
	wp_dequeue_style( 'wpsight-listings-map' );
 ...
 * @since 1.0.0
 */
add_filter( 'wpsight_dashboard_columns', 'wpsight_elviria_dashboard_columns' );

function wpsight_elviria_dashboard_columns( $columns ) {
