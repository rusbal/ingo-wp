...
class WPSight_Elviria_Shortcode_Image_Slider {
	...
	public function shortcode_image_slider( $atts ) {
        ...
        // Echo listing slider
		wpsight_elviria_image_slider( $thumbs_ids, $slider_args );
		...
		return apply_filters( 'wpsight_elviria_shortcode_image_slider', $output, $atts );

	}

}

new WPSight_Elviria_Shortcode_Image_Slider();
