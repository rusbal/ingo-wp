...
class WPSight_Elviria_Shortcode_Image_Gallery {
	...
	public function shortcode_image_gallery( $atts ) {
		...
		wpsight_elviria_image_gallery( $thumbs_ids, $gallery_args );
		...
		return apply_filters( 'wpsight_elviria_shortcode_image_gallery', $output, $atts );

	}

}

new WPSight_Elviria_Shortcode_Image_Gallery();
