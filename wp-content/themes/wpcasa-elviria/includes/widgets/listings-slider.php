...
add_action( 'widgets_init', 'wpsight_elviria_register_widget_listings_slider' );
 
function wpsight_elviria_register_widget_listings_slider() {
	register_widget( 'WPSight_Elviria_Listings_Slider' );
}
...
class WPSight_Elviria_Listings_Slider extends WP_Widget {

	public function __construct() {

		$widget_ops = array(
			'classname'   => 'widget_listings_slider',
			'description' => _x( 'Display listings in a slider.', 'listing wigdet', 'wpcasa-elviria' )
		);

		parent::__construct( 'wpsight_elviria_listings_slider', '&rsaquo; ' . WPSIGHT_ELVIRIA_NAME . ' ' . _x( 'Listings Slider', 'listing widget', 'wpcasa-elviria' ), $widget_ops );
	...
	public function widget( $args, $instance ) {
		...
		$listings_args = apply_filters( 'wpsight_elviria_widget_listings_slider_query_args', array_merge( $listings_args, $taxonomy_filters ), $instance, $this->id );
		...
		wpsight_elviria_listings_slider( $listings, $slider_args );
