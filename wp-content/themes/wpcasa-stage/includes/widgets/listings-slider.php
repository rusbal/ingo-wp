...
add_action( 'widgets_init', 'wpsight_stage_register_widget_listings_slider' );
 
function wpsight_stage_register_widget_listings_slider() {
	register_widget( 'WPSight_STAGE_Listings_Slider' );
}
...
class WPSight_STAGE_Listings_Slider extends WP_Widget {

	public function __construct() {

		$widget_ops = array(
			'classname'   => 'widget_listings_slider',
			'description' => _x( 'Display listings in a slider.', 'listing wigdet', 'wpsight-stage' )
		);

		parent::__construct( 'wpsight_stage_listings_slider', '&rsaquo; ' . WPSIGHT_STAGE_NAME . ' ' . _x( 'Listings Slider', 'listing widget', 'wpsight-stage' ), $widget_ops );
	...
	public function widget( $args, $instance ) {
		...
		$listings_args = apply_filters( 'wpsight_stage_widget_listings_slider_query_args', array_merge( $listings_args, $taxonomy_filters ), $instance, $this->id );
		...
		wpsight_stage_get_listings_slider( $listings, $slider_args );
