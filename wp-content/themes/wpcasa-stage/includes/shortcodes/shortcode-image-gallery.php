...
class WPSight_STAGE_Shortcode_Image_Gallery {
	...
	public function shortcode_image_gallery( $atts ) {
		...
		wpsight_stage_image_gallery( $thumbs_ids, $gallery_args );
		...
		return apply_filters( 'wpsight_stage_shortcode_image_gallery', $output, $atts );

	}

}

new WPSight_STAGE_Shortcode_Image_Gallery();
