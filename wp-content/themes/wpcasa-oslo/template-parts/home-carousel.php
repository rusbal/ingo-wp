...
if( $display ) : ?>
	...
	<?php
		...
		// Apply filter hook
		$carousel_args = apply_filters( 'wpsight_oslo_listings_carousel_args', $carousel_args, $instance, 'home' );
		...
		$listings_args = apply_filters( 'wpsight_oslo_listings_carousel_query_args', array_merge( $listings_args, $taxonomy_filters ), $instance, 'home' );
	...
	<div id="home-carousel" class="site-section home-section">
		...
		<div class="container">
			<?php wpsight_oslo_listings_carousel( $listings, $carousel_args ); ?>		
		</div><!-- .container -->
