	...
	<?php if( $full_width ) : ?><div class="container"><?php endif; ?>
		...
		<div class="feature-box-info equal">
			...
			<div class="feature-box-link">
				<a href="<?php echo esc_url( $args['link_url'] ); ?>" <?php if( $args['link_blank'] ) echo ' target="_blank"'; ?> class="btn <?php echo sanitize_html_class( $button_class ); ?> btn-sm"><?php echo strip_tags( $args['link_text'] ); ?></a>
			</div>
			<?php endif; ?>
