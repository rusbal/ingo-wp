 ...
 * Register widget
 */
add_action( 'widgets_init', 'wpsight_oslo_register_widget_listing_image_slider' );
 
function wpsight_oslo_register_widget_listing_image_slider() {
	register_widget( 'WPSight_Oslo_Listing_Image_Slider' );
}

/**
 * Listing slider widget class
 */
class WPSight_Oslo_Listing_Image_Slider extends WP_Widget {

	public function __construct() {

		$widget_ops = array(
			'classname'   => 'widget_listing_image_slider',
			'description' => _x( 'Display listing images in slider.', 'listing wigdet', 'wpcasa-oslo' )
		);

		parent::__construct( 'wpsight_oslo_listing_image_slider', '&rsaquo; ' . _x( 'Single Listing Image Slider', 'listing widget', 'wpcasa-oslo' ), $widget_ops );
	...
	public function form( $instance ) {
		...
		<p><label for="<?php echo $this->get_field_id( 'image_size' ); ?>"><?php _e( 'Image Size', 'wpcasa-oslo' ); ?>:</label><br />
		...
		<p><label for="<?php echo $this->get_field_id( 'slider_animation' ); ?>"><?php _e( 'Animation', 'wpcasa-oslo' ); ?>:</label><br />
			<select class="widefat" id="<?php echo $this->get_field_id( 'slider_animation' ); ?>" name="<?php echo $this->get_field_name( 'slider_animation' ); ?>">
				<option value="fade"<?php selected( $slider_animation, 'fade' ); ?>><?php _ex( 'fade', 'listing widget', 'wpcasa-oslo' ); ?></option>
				<option value="slide"<?php selected( $slider_animation, 'slide' ); ?>><?php _ex( 'slide', 'listing widget', 'wpcasa-oslo' ); ?></option>
			</select></p>
		...
		<p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'slider_loop' ); ?>" name="<?php echo $this->get_field_name( 'slider_loop' ); ?>"<?php checked( $slider_loop ); ?> />
				<label for="<?php echo $this->get_field_id( 'slider_loop' ); ?>"><?php _e( 'Loop slider to be infinite', 'wpcasa-oslo' ); ?></label></p>
		...
		<p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'slider_autoplay' ); ?>" name="<?php echo $this->get_field_name( 'slider_autoplay' ); ?>"<?php checked( $slider_autoplay ); ?> />
				<label for="<?php echo $this->get_field_id( 'slider_autoplay' ); ?>"><?php _e( 'Animate slider automatically', 'wpcasa-oslo' ); ?></label></p>
			
		<div<?php if( ! $slider_autoplay ) echo ' style="display:none"'; ?>>
		
			<p><label for="<?php echo $this->get_field_id( 'slider_autoplay_time' ); ?>"><?php _e( 'Autoplay interval', 'wpcasa-oslo' ); ?>:</label><br />
				<select class="widefat" id="<?php echo $this->get_field_id( 'slider_autoplay_time' ); ?>" name="<?php echo $this->get_field_name( 'slider_autoplay_time' ); ?>">
					<option value="2000"<?php selected( $slider_autoplay_time, 2000 ); ?>>2 <?php _ex( 'seconds', 'listing widget', 'wpcasa-oslo' ); ?></option>
					<option value="4000"<?php selected( $slider_autoplay_time, 4000 ); ?>>4 <?php _ex( 'seconds', 'listing widget', 'wpcasa-oslo' ); ?></option>
					<option value="6000"<?php selected( $slider_autoplay_time, 6000 ); ?>>6 <?php _ex( 'seconds', 'listing widget', 'wpcasa-oslo' ); ?></option>
					<option value="8000"<?php selected( $slider_autoplay_time, 8000 ); ?>>8 <?php _ex( 'seconds', 'listing widget', 'wpcasa-oslo' ); ?></option>
					<option value="10000"<?php selected( $slider_autoplay_time, 10000 ); ?>>10 <?php _ex( 'seconds', 'listing widget', 'wpcasa-oslo' ); ?></option>
				</select></p>
		...
		<p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'slider_dots' ); ?>" name="<?php echo $this->get_field_name( 'slider_dots' ); ?>"<?php checked( $slider_dots ); ?> />
				<label for="<?php echo $this->get_field_id( 'slider_dots' ); ?>"><?php _e( 'Show <em>dots</em> slider navigation', 'wpcasa-oslo' ); ?></label></p>
		...
		<div<?php if( ! $slider_dots ) echo ' style="display:none"'; ?>>
			...
			<p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'slider_dots_thumbs' ); ?>" name="<?php echo $this->get_field_name( 'slider_dots_thumbs' ); ?>"<?php checked( $slider_dots_thumbs ); ?> />
					<label for="<?php echo $this->get_field_id( 'slider_dots_thumbs' ); ?>"><?php _e( 'Show thumbnails instead of <em>dots</em>', 'wpcasa-oslo' ); ?></label></p>
					
			<div<?php if( ! $slider_dots_thumbs ) echo ' style="display:none"'; ?>>
			
				<p><label for="<?php echo $this->get_field_id( 'slider_dots_thumbs_items' ); ?>"><?php _e( 'Number of thumbnail items', 'wpcasa-oslo' ); ?>:</label><br />
				...
				<p><label for="<?php echo $this->get_field_id( 'slider_dots_thumbs_margin' ); ?>"><?php _e( 'Margin between thumbnail items', 'wpcasa-oslo' ); ?>:</label><br />
		...
		<p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'slider_nav' ); ?>" name="<?php echo $this->get_field_name( 'slider_nav' ); ?>"<?php checked( $slider_nav ); ?> />
				<label for="<?php echo $this->get_field_id( 'slider_nav' ); ?>"><?php _e( 'Show prev/next slider navigation', 'wpcasa-oslo' ); ?></label></p>
		...
		<p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'slider_keyboard' ); ?>" name="<?php echo $this->get_field_name( 'slider_keyboard' ); ?>"<?php checked( $slider_keyboard ); ?> />
				<label for="<?php echo $this->get_field_id( 'slider_keyboard' ); ?>"><?php _e( 'Allow slider navigating via keyboard', 'wpcasa-oslo' ); ?></label></p>
		...
		<p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'image_caption' ); ?>" name="<?php echo $this->get_field_name( 'image_caption' ); ?>"<?php checked( $image_caption ); ?> />
			<label for="<?php echo $this->get_field_id( 'image_caption' ); ?>"><?php _e( 'Display image captions (if any)', 'wpcasa-oslo' ); ?></label></p>	
