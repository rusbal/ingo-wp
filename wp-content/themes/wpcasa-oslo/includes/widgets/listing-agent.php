 ...
 * Register widget
 */
add_action( 'widgets_init', 'wpsight_oslo_register_widget_listing_agent' );
 
function wpsight_oslo_register_widget_listing_agent() {
	register_widget( 'WPSight_Oslo_Listing_Agent' );
}

/**
 * Listing agent widget class
 */
class WPSight_Oslo_Listing_Agent extends WP_Widget {

	public function __construct() {

		$widget_ops = array(
			'classname'   => 'widget_listing_agent',
			'description' => _x( 'Display listing agent on single listing pages.', 'listing wigdet', 'wpcasa-oslo' )
		);

		parent::__construct( 'wpsight_oslo_listing_agent', '&rsaquo; ' . _x( 'Single Listing Agent', 'listing widget', 'wpcasa-oslo' ), $widget_ops );
	...
	public function form( $instance ) {
		...
		<p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'display_image' ); ?>" name="<?php echo $this->get_field_name( 'display_image' ); ?>"<?php checked( $display_image ); ?> />
			<label for="<?php echo $this->get_field_id( 'display_image' ); ?>"><?php _e( 'Display agent image', 'wpcasa-oslo' ); ?></label></p>
		...
		<p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'display_company' ); ?>" name="<?php echo $this->get_field_name( 'display_company' ); ?>"<?php checked( $display_company ); ?> />
			<label for="<?php echo $this->get_field_id( 'display_company' ); ?>"><?php _e( 'Display agent company', 'wpcasa-oslo' ); ?></label></p>
		...
		<p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'display_phone' ); ?>" name="<?php echo $this->get_field_name( 'display_phone' ); ?>"<?php checked( $display_phone ); ?> />
			<label for="<?php echo $this->get_field_id( 'display_phone' ); ?>"><?php _e( 'Display agent phone', 'wpcasa-oslo' ); ?></label></p>
		...
		<p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'display_social' ); ?>" name="<?php echo $this->get_field_name( 'display_social' ); ?>"<?php checked( $display_social ); ?> />
			<label for="<?php echo $this->get_field_id( 'display_social' ); ?>"><?php _e( 'Display social profiles', 'wpcasa-oslo' ); ?></label></p>
		...
		<p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'display_archive' ); ?>" name="<?php echo $this->get_field_name( 'display_archive' ); ?>"<?php checked( $display_archive ); ?> />
			<label for="<?php echo $this->get_field_id( 'display_archive' ); ?>"><?php _e( 'Display agent archive link', 'wpcasa-oslo' ); ?></label></p><?php
