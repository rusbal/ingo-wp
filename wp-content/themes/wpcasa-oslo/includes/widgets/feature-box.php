 ...
 * Register widget
 */
add_action( 'widgets_init', 'wpsight_oslo_register_widget_feature_box' );
 
function wpsight_oslo_register_widget_feature_box() {
	register_widget( 'WPSight_Oslo_Feature_Box' );
}

/**
 * Feature box widget class
 */
class WPSight_Oslo_Feature_Box extends WP_Widget {

	public function __construct() {

		$widget_ops = array(
			'classname'   => 'widget_feature_box',
			'description' => _x( 'Display a feature box with icon.', 'listing wigdet', 'wpcasa-oslo' )
		);

		parent::__construct( 'wpsight_oslo_feature_box', '&rsaquo; ' . _x( 'Feature Box', 'listing widget', 'wpcasa-oslo' ), $widget_ops );
	...
	public function widget( $args, $instance ) {
		...
		// Display feature box
		wpsight_oslo_feature_box( $instance, $args );
