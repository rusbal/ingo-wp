 ...
 * Register widget
 */
add_action( 'widgets_init', 'wpsight_oslo_register_widget_listing_location' );
 
function wpsight_oslo_register_widget_listing_location() {
	register_widget( 'WPSight_Oslo_Listing_Location' );
}

/**
 * Listing location widget class
 */
class WPSight_Oslo_Listing_Location extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'wpsight_oslo_listing_location', '&rsaquo; ' . _x( 'Single Listing Location', 'listing widget', 'wpsight-stage' ), $widget_ops );
	...
	public function form( $instance ) {
		...
		<p><label for="<?php echo $this->get_field_id( 'map_type' ); ?>"><?php _e( 'Map Type', 'wpcasa-oslo' ); ?>:</label><br />
			<select class="widefat" id="<?php echo $this->get_field_id( 'map_type' ); ?>" name="<?php echo $this->get_field_name( 'map_type' ); ?>">
				<option value="ROADMAP"<?php selected( $map_type, 'ROADMAP' ); ?>><?php _ex( 'Roadmap', 'listing widget', 'wpcasa-oslo' ); ?></option>
				<option value="SATELLITE"<?php selected( $map_type, 'SATELLITE' ); ?>><?php _ex( 'Satellite', 'listing widget', 'wpcasa-oslo' ); ?></option>
				<option value="HYBRID"<?php selected( $map_type, 'HYBRID' ); ?>><?php _ex( 'Hybrid', 'listing widget', 'wpcasa-oslo' ); ?></option>
				<option value="TERRAIN"<?php selected( $map_type, 'TERRAIN' ); ?>><?php _ex( 'Terrain', 'listing widget', 'wpcasa-oslo' ); ?></option>
			</select></p>
		
		<p><label for="<?php echo $this->get_field_id( 'map_zoom' ); ?>"><?php _e( 'Map Zoom', 'wpcasa-oslo' ); ?>:</label><br />
		...
		<p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'map_no_streetview' ); ?>" name="<?php echo $this->get_field_name( 'map_no_streetview' ); ?>"<?php checked( $map_streetview ); ?> />
			<label for="<?php echo $this->get_field_id( 'map_no_streetview' ); ?>"><?php _e( 'Disable streetview', 'wpcasa-oslo' ); ?></label></p>
		...
		<p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'map_control_type' ); ?>" name="<?php echo $this->get_field_name( 'map_control_type' ); ?>"<?php checked( $map_control_type ); ?> />
			<label for="<?php echo $this->get_field_id( 'map_control_type' ); ?>"><?php _e( 'Enable type control', 'wpcasa-oslo' ); ?></label></p>
		...
		<p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'map_control_nav' ); ?>" name="<?php echo $this->get_field_name( 'map_control_nav' ); ?>"<?php checked( $map_control_nav ); ?> />
			<label for="<?php echo $this->get_field_id( 'map_control_nav' ); ?>"><?php _e( 'Enable nav control', 'wpcasa-oslo' ); ?></label></p>
		...
		<p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'map_scrollwheel' ); ?>" name="<?php echo $this->get_field_name( 'map_scrollwheel' ); ?>"<?php checked( $map_scrollwheel ); ?> />
			<label for="<?php echo $this->get_field_id( 'map_scrollwheel' ); ?>"><?php _e( 'Enable scrollwheel', 'wpcasa-oslo' ); ?></label></p>
		...
		<p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'display_note' ); ?>" name="<?php echo $this->get_field_name( 'display_note' ); ?>"<?php checked( $display_note ); ?> />
			<label for="<?php echo $this->get_field_id( 'display_note' ); ?>"><?php _e( 'Display public note', 'wpcasa-oslo' ); ?></label></p>
