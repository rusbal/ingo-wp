...
add_action( 'widgets_init', 'wpsight_oslo_register_widget_listings_slider' );
 
function wpsight_oslo_register_widget_listings_slider() {
	register_widget( 'WPSight_Oslo_Listings_Slider' );
}
...
class WPSight_Oslo_Listings_Slider extends WP_Widget {

	public function __construct() {

		$widget_ops = array(
			'classname'   => 'widget_listings_slider',
			'description' => _x( 'Display listings in a slider.', 'listing wigdet', 'wpcasa-oslo' )
		);

		parent::__construct( 'wpsight_oslo_Listings_Slider', '&rsaquo; ' . _x( 'Listings Slider', 'listing widget', 'wpcasa-oslo' ), $widget_ops );
	...
	public function widget( $args, $instance ) {
		...
		$listings_args = apply_filters( 'wpsight_oslo_widget_listings_slider_query_args', array_merge( $listings_args, $taxonomy_filters ), $instance, $this->id );
		...
		wpsight_oslo_listings_slider( $listings, $slider_args );
	...
	public function form( $instance ) {
		...
		<p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'slider_keyboard' ); ?>" name="<?php echo $this->get_field_name( 'slider_keyboard' ); ?>"<?php checked( $slider_keyboard ); ?> />
				<label for="<?php echo $this->get_field_id( 'slider_keyboard' ); ?>"><?php _e( 'Allow slider navigating via keyboard', 'wpcasa-oslo' ); ?></label></p><?php
