 ...
 * Register widget
 */
add_action( 'widgets_init', 'wpsight_oslo_register_widget_call_to_action' );
 
function wpsight_oslo_register_widget_call_to_action() {
	register_widget( 'WPSight_Oslo_Call_To_Action' );
}

/**
 * Call to action widget class
 */
class WPSight_Oslo_Call_To_Action extends WP_Widget {

	public function __construct() {

		$widget_ops = array(
			'classname'   => 'widget_call_to_action',
			'description' => _x( 'Display a call to action.', 'listing wigdet', 'wpcasa-oslo' )
		);

		parent::__construct( 'wpsight_oslo_call_to_action', '&rsaquo; ' . _x( 'Call to Action', 'listing widget', 'wpcasa-oslo' ), $widget_ops );
	...
	public function widget( $args, $instance ) {
		...
		// Display feature box
		wpsight_oslo_call_to_action( $instance, $args );
	...
	public function form( $instance ) {
		...
		<p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'link_blank' ); ?>" name="<?php echo $this->get_field_name( 'link_blank' ); ?>"<?php checked( $instance['link_blank'] ); ?> />
			<label for="<?php echo $this->get_field_id( 'link_blank' ); ?>"><?php _e( 'Open link in new tab or window', 'wpcasa-oslo' ); ?></label></p>
		...
		<p><label for="<?php echo $this->get_field_id( 'orientation' ); ?>"><?php _e( 'Orientation', 'wpcasa-oslo' ); ?>:</label><br />
			<select class="widefat" id="<?php echo $this->get_field_id( 'orientation' ); ?>" name="<?php echo $this->get_field_name( 'orientation' ); ?>">
				<option value="horizontal"<?php selected( $instance['orientation'], 'horizontal' ); ?>><?php _ex( 'horizontal', 'listing widget', 'wpcasa-oslo' ); ?></option>
				<option value="vertical"<?php selected( $instance['orientation'], 'vertical' ); ?>><?php _ex( 'vertical', 'listing widget', 'wpcasa-oslo' ); ?></option>
			</select><br />
