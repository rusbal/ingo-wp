...
/**
 * wpsight_oslo_image_gallery()
 *
 * Echo wpsight_oslo_get_gallery()
 *
 * @param integer|array $post_id Post ID or array of attachment IDs
 * @param array $args Optional gallery arguments
 *
 * @uses wpsight_oslo_get_image_gallery()
 *
 * @since 1.0.0
 */
function wpsight_oslo_image_gallery( $post_id = '', $args = array() ) {
	echo wpsight_oslo_get_image_gallery( $post_id, $args );
}

/**
 * wpsight_oslo_get_image_gallery()
 *
 ...
 * @uses wpsight_oslo_image_gallery_root()
 * @uses wpsight_oslo_image_gallery_js()
 *
 * @return string HTML markup of thumbnail gallery with lightbox
 *
 * @since 1.0.0
 */
function wpsight_oslo_get_image_gallery( $post_id = '', $args = array() ) {
	...
	if( $images ) {
		...
		$args = apply_filters( 'wpsight_oslo_get_image_gallery_args', wp_parse_args( $args, $defaults ), $post_id, $args );
		...
		return apply_filters( 'wpsight_oslo_get_image_gallery', ob_get_clean(), $post_id, $args, $gallery_id );
