...
<div class="wpsight-listing-section wpsight-listing-section-agent" itemprop="seller" itemscope itemtype="http://schema.org/RealEstateAgent">
	...
	<div class="wpsight-listing-agent clearfix">
	    ...
	    <div class="wpsight-listing-agent-image image center">
	        ...
	        <span itemprop="image"><?php wpsight_listing_agent_image( $listing->ID, array( 150, 150 ) ); ?></span>
	    ...
	    <div class="wpsight-listing-agent-info">
	        ...
	        <div class="wpsight-listing-agent-links">
	        	...
	        	<a href="<?php wpsight_listing_agent_website( $listing->ID ); ?>" class="tips agent-website icon fa-link" data-tip="<?php echo esc_attr( wpsight_get_listing_agent_website( $listing->ID ) ); ?>" itemprop="url" target="_blank" rel="nofollow"><span class="label"><?php _e( 'Website', 'wpcasa-bahia' ); ?></span></a>
	        	<?php endif; ?>
	        	
	        	<?php if( wpsight_get_listing_agent_twitter( $listing->ID ) ) : ?>
	        	<a href="<?php wpsight_listing_agent_twitter( $listing->ID, 'url' ); ?>" class="tips agent-twitter icon fa-twitter" data-tip="@<?php echo esc_attr( wpsight_get_listing_agent_twitter( $listing->ID ) ); ?>" target="_blank" rel="nofollow"><span class="label"><?php _e( 'Twitter', 'wpcasa-bahia' ); ?></span></a>
	        	<?php endif; ?>
	        	
	        	<?php if( wpsight_get_listing_agent_facebook( $listing->ID ) ) : ?>
	        	<a href="<?php wpsight_listing_agent_facebook( $listing->ID, 'url' ); ?>" class="tips agent-facebook icon fa-facebook" data-tip="<?php echo esc_attr( wpsight_get_listing_agent_facebook( $listing->ID ) ); ?>" target="_blank" rel="nofollow"><span class="label"><?php _e( 'Facebook', 'wpcasa-bahia' ); ?></span></a>
	        	<?php endif; ?>
	        ...
	        <div class="wpsight-listing-agent-archive">
	        	<a href="<?php wpsight_listing_agent_archive( $listing->ID ); ?>" class="button"><?php _e( 'My Listings', 'wpcasa-bahia' ); ?></a>
	        </div>
	        <?php endif; ?>
