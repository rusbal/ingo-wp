	    ...
	    <div class="wpsight-list-agent-info">
	        ...
	        <?php if( $args['show_links'] !== false ) : ?>
	        	...
	        	<div class="wpsight-list-agent-links">
					...
					<a href="<?php wpsight_agent_website( $user->ID ); ?>" class="tips agent-website icon fa-link" data-tip="<?php echo esc_attr__( 'Website', 'wpcasa-bahia' ); ?>" itemprop="url" target="_blank" rel="nofollow"><span class="label"><?php _e( 'Website', 'wpcasa-bahia' ); ?></span></a>
					<?php endif; ?>
					
					<?php if( wpsight_get_agent_twitter( $user->ID ) ) : ?>
					<a href="<?php wpsight_agent_twitter( $user->ID, 'url' ); ?>" class="tips agent-twitter icon fa-twitter" data-tip="<?php echo esc_attr__( 'Twitter', 'wpcasa-bahia' ); ?>" target="_blank" rel="nofollow"><span class="label"><?php _e( 'Twitter', 'wpcasa-bahia' ); ?></span></a>
					<?php endif; ?>
					
					<?php if( wpsight_get_agent_facebook( $user->ID ) ) : ?>
					<a href="<?php wpsight_agent_facebook( $user->ID, 'url' ); ?>" class="tips agent-facebook icon fa-facebook" data-tip="<?php echo esc_attr__( 'Facebook', 'wpcasa-bahia' ); ?>" target="_blank" rel="nofollow"><span class="label"><?php _e( 'Facebook', 'wpcasa-bahia' ); ?></span></a>
					<?php endif; ?>
	        ...
	        <div class="wpsight-list-agent-archive">
	        	<a href="<?php wpsight_agent_archive( $user->ID ); ?>" class="button"><?php _e( 'My Listings', 'wpcasa-bahia' ); ?></a>
	        </div>
	        <?php endif; ?>
