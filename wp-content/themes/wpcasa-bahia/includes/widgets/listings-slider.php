...
add_action( 'widgets_init', 'wpsight_bahia_register_widget_listings_slider' );
 
function wpsight_bahia_register_widget_listings_slider() {
	register_widget( 'WPSight_Bahia_Listings_Slider' );
}
...
class WPSight_Bahia_Listings_Slider extends WP_Widget {

	public function __construct() {

		$widget_ops = array(
			'classname'   => 'widget_listings_slider',
			'description' => _x( 'Display listings in a slider.', 'listing wigdet', 'wpcasa-bahia' )
		);

		parent::__construct( 'wpsight_bahia_listings_slider', '&rsaquo; ' . WPSIGHT_BAHIA_NAME . ' ' . _x( 'Listings Slider', 'listing widget', 'wpcasa-bahia' ), $widget_ops );
	...
	public function widget( $args, $instance ) {
		...
		$listings_args = apply_filters( 'wpsight_bahia_widget_listings_slider_query_args', array_merge( $listings_args, $taxonomy_filters ), $instance, $this->id );
		...
		wpsight_bahia_listings_slider( $listings, $slider_args );
