...
class WPSight_Bahia_Shortcode_Image_Slider {
	...
	public function shortcode_image_slider( $atts ) {
        ...
        // Echo listing slider
		wpsight_bahia_image_slider( $thumbs_ids, $slider_args );
		...
		return apply_filters( 'wpsight_bahia_shortcode_image_slider', $output, $atts );

	}

}

new WPSight_Bahia_Shortcode_Image_Slider();
