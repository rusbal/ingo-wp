<?php
/**
 * class wpsight_bahia_Walker_Category_Checklist
 *
...
class wpsight_bahia_Walker_Category_Checklist extends Walker_Category_Checklist {
 ...
 * @since 1.0.0
 */
add_filter( 'wpsight_listing_actions', 'wpsight_bahia_listing_actions' );

function wpsight_bahia_listing_actions( $output ) {
 ...
 * @since 1.0.0
 */
add_action( 'wp_enqueue_scripts', 'wpsight_bahia_dequeue_addon_scripts' );

function wpsight_bahia_dequeue_addon_scripts() {	
 ...
 * @since 1.0.0
 */
add_filter( 'wpsight_dashboard_columns', 'wpsight_bahia_dashboard_columns' );

function wpsight_bahia_dashboard_columns( $columns ) {
