<?php
/**
 * WPCasa Bahia listings carousel
 *
 * @package WPCasa Bahia
 */

/**
 * wpsight_bahia_listings_carousel()
 *
 * Echo wpsight_bahia_get_listings_carousel()
 *
 * @param object|array $listings Query object or post IDs array
 * @param array $args Optional carousel arguments
 *
 * @uses wpsight_bahia_get_listings_carousel()
 *
 * @since 1.0.0
 */
 
function wpsight_bahia_listings_carousel( $listings = array(), $args = array() ) {
	echo wpsight_bahia_get_listings_carousel( $listings, $args );
}

/**
 * wpsight_bahia_get_listings_carousel()
 *
...
function wpsight_bahia_get_listings_carousel( $listings = array(), $args = array() ) {
	global $post;
	...
	if( $listings ) {
		...
		$args = apply_filters( 'wpsight_bahia_get_listings_carousel_args', wp_parse_args( $args, $defaults ), $listings, $args );
		...
		return apply_filters( 'wpsight_bahia_get_listings_carousel', ob_get_clean(), $listings, $args );
