<?php
/**
 * WPCasa Bahia gallery
 *
 * @package WPCasa Bahia
 */

add_filter( 'wpsight_meta_boxes', 'wpsight_bahia_meta_boxes_listing_images' );

function wpsight_bahia_meta_boxes_listing_images( $meta_boxes ) {
...
/**
 * wpsight_bahia_image_gallery()
 *
 * Echo wpsight_bahia_get_gallery()
 *
 * @param integer|array $post_id Post ID or array of attachment IDs
 * @param array $args Optional gallery arguments
 *
 * @uses wpsight_bahia_get_image_gallery()
 *
 * @since 1.0.0
 */
 
function wpsight_bahia_image_gallery( $post_id = '', $args = array() ) {
	echo wpsight_bahia_get_image_gallery( $post_id, $args );
}

/**
 * wpsight_bahia_get_image_gallery()
 *
 ...
 * @uses wpsight_bahia_image_gallery_root()
 * @uses wpsight_bahia_image_gallery_js()
 *
...
function wpsight_bahia_get_image_gallery( $post_id = '', $args = array() ) {
	...
	if( $images ) {
		...
		$args = apply_filters( 'wpsight_bahia_get_image_gallery_args', wp_parse_args( $args, $defaults ), $post_id, $args );
		...
		if( apply_filters( 'wpsight_bahia_photoswipe', true ) == true ) {
			wpsight_bahia_image_gallery_root( $args, $gallery_id );
			wpsight_bahia_image_gallery_js( $args, $gallery_id );
		}
		
		return apply_filters( 'wpsight_bahia_get_image_gallery', ob_get_clean(), $post_id, $args, $gallery_id );
...
/**
 * wpsight_bahia_image_gallery_root()
 *
 * Echo wpsight_bahia_get_image_gallery_root()
 *
...
function wpsight_bahia_image_gallery_root( $args = array(), $gallery_id ) {
	echo wpsight_bahia_get_image_gallery_root( $args, $gallery_id );
}

/**
 * wpsight_bahia_get_image_gallery_root()
 *
...
function wpsight_bahia_get_image_gallery_root( $args = array(), $gallery_id ) {
	    ...
	    <div class="pswp__scroll-wrap">
	        ...
	        <div class="pswp__ui pswp__ui--hidden">		
	            <div class="pswp__top-bar">
	                ...
	                <button class="pswp__button pswp__button--close" title="<?php echo esc_attr_x( 'Close (Esc)', 'photoswipe lightbox', 'wpcasa-bahia' ); ?>"></button>
	                <?php endif; ?>
	                
	                <?php if( $args['lightbox_share'] )	: ?>
	                <button class="pswp__button pswp__button--share" title="<?php echo esc_attr_x( 'Share', 'photoswipe lightbox', 'wpcasa-bahia' ); ?>"></button>
	                <?php endif; ?>
	                
	                <?php if( $args['lightbox_fullscreen'] ) : ?>
	                <button class="pswp__button pswp__button--fs" title="<?php echo esc_attr_x( 'Fullscreen', 'photoswipe lightbox', 'wpcasa-bahia' ); ?>"></button>
	                <?php endif; ?>
	                
	                <?php if( $args['lightbox_zoom'] ) : ?>
	                <button class="pswp__button pswp__button--zoom" title="<?php echo esc_attr_x( 'Zoom', 'photoswipe lightbox', 'wpcasa-bahia' ); ?>"></button>
	                <?php endif; ?>
	            ...
	            <button class="pswp__button pswp__button--arrow--left" title="<?php echo esc_attr_x( 'Previous', 'photoswipe lightbox', 'wpcasa-bahia' ); ?>">
	            </button>		
	            <button class="pswp__button pswp__button--arrow--right" title="<?php echo esc_attr_x( 'Next', 'photoswipe lightbox', 'wpcasa-bahia' ); ?>">
	            </button>
	            <?php endif; ?>
	...
	return apply_filters( 'wpsight_bahia_get_image_gallery_root', ob_get_clean(), $args, $gallery_id );

}

/**
 * wpsight_bahia_image_gallery_js()
 *
 * Echo wpsight_bahia_get_image_gallery_js()
 *
 * @param array $args Array of arguments
...
function wpsight_bahia_image_gallery_js( $args = array(), $gallery_id ) {
	echo wpsight_bahia_get_image_gallery_js( $args, $gallery_id );
}

/**
 * wpsight_bahia_get_image_gallery_js()
 *
...
function wpsight_bahia_get_image_gallery_js( $args = array(), $gallery_id ) {
	...
	return apply_filters( 'wpsight_bahia_get_image_gallery_js', ob_get_clean(), $args, $gallery_id );
