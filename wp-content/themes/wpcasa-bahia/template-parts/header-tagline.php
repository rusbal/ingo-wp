...
$tagline_display = get_option( 'wpsight_bahia_header_tagline_display', 'home' );
...
<div id="home-tagline" class="site-section home-section<?php echo $animate; ?>">
	...
	<div class="container">
		...
		<div class="content 12u$">
			...
			<div id="tagline">
				<?php echo get_option( 'wpsight_bahia_header_tagline', '<span>Let us help you find <em>your dream</em> home</span>' ); ?>
			</div>
